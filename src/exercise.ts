...
function getAllowedCharacters():numberString[] {
...
function getRandomItemFromArray(array:numberString[]) {
...
function getMandatoryCharacters():numberString[] {
...
function getRandomCharacters(numberOfCharacters:number) :numberString[]{
    const randomCharacters:numberString[] = [];
    const allowedCharacters:numberString[] = getAllowedCharacters();
...
function shuffleArray(array:numberString[]):numberString[] {
    return array.sort(() => 0.5 - Math.random());
}

// generate the final result
function generatePassword() {
    const requiredCharacters:numberString[] = getMandatoryCharacters();
    const remainingCharacters:numberString[] = getRandomCharacters(
        passwordLength - requiredCharacters.length
    );

    const generatedCharacters:numberString[] = [...requiredCharacters, ...remainingCharacters];
    const shuffledChars:numberString[] = shuffleArray(generatedCharacters);
